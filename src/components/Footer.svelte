...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> miguel99silva@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/miguelsiloli" target="_blank" class="text-blue-200"
                >miguelsiloli<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/miguel-oliveira-862907243/" target="_blank" class="text-violet-400"
                >Miguel Oliveira<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
